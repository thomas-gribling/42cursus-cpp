...
ClapTrap::ClapTrap() {
	std::cout << "[CONSTRUCTOR]: " << "An unnamed trap has been placed!" << std::endl;
	_hp = 10;
	_ep = 10;
	_dmg = 0;
}
...
ClapTrap::ClapTrap( ClapTrap const &src ) {
	std::cout << "[CONSTRUCTOR]: " << src._name << " has been copied and placed!" << std::endl;
	*this = src;
}

ClapTrap::ClapTrap( std::string name ) {
	std::cout << "[CONSTRUCTOR]: " << name << " has been placed!" << std::endl;
	_name = name;
	_hp = 10;
	_ep = 10;
	_dmg = 0;
...
ClapTrap::~ClapTrap() {
	std::cout << "[DESTRUCTOR]: " << _name << " successfully destroyed!" << std::endl;
}
